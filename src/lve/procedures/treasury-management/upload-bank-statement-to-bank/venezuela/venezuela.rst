...
Para la exportación de los archivos desde ADempiere al banco de venezuela, `Almientos Masía`_ soporta el siguiente formato facilitado por el banco, que puede ser descargado. El documento :download:`Formato Archivo de Pago a Proveedore <FormatoDeArchivoPagoProveedores.pdf>`, explica el formato que sirve de ayuda para la construcción el archivo a cargar. 
