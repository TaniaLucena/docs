...
Para la exportación de los archivos desde ADempiere al banco nacional de crédito, `Alimentos Masía`_ soporta el siguiente formato facilitado por el banco, que puede ser descargado para su análisis y adaptación.
