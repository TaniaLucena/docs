...
Para la exportación de los archivos desde ADempiere al banco provincial, `Almientos Masía`_ soporta los siguientes formatos facilitados por el banco, que pueden ser descargados para su análisis y adaptación.
