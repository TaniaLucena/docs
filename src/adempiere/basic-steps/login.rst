...
Para acceder o iniciar sesión en ADempiere, el usuario requiere lo siguiente:
    ...
    - Credenciales de acceso (Facilitadas por un consultor de Almientos Masía)

        - Usuario: Estandar

        - Clave: Estandar

    - Rol asignado al usuario creado por Almientos Masía

Al ingresar a la url del servicio de ADempiere facilitada por un consultor de Almientos Masía, podrá visualizar la ventana "**Login**" o "**Iniciar Sesión**", la cual cuenta con los campos necesarios para iniciar sesión en el idioma que el usuario lo requiera.
...
Introduzca en el campo "**Usuario**", el usuario previamente facilitado por el consultor de Almientos Masía.

    |Campo Usuario|

    Imagen 2. Usuario

Introduzca en el campo "**Contraseña**", la contraseña del usuario previamente facilitada por el consultor de Almientos Masía.
