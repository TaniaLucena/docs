...
Para que pueda conocer cómo y cuándo usar esta funcionalidad `Almientos Masía`_ ha estructurado un material, basado en la gama de opciones disponibles para establecer un patrón de comportamiento al ejecutar las distribuciones.
