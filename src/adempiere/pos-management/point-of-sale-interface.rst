...
"**Icono Tipo de Documento**": Permite cambiar el tipo de documento cargado por defecto, el mismo define el comportamiento del documento que se esta generando y se encuentra explicado en el material **Tipo de Documento** elaborado por `Alimentos Masía`_. Adicional a ello, se puede ejecutar esta acción seleccionando la tecla "**F10**".
