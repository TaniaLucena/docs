...
Proceda al llenado de los campos necesarios que a continuación se detallan.
    ...
    Seleccione la organización en el campo "**Organización**".
        ...
        .. warning::
            ...
            Generalmente los **Socios de Negocios** son registros compartidos entre entidades organizacionales, por esta razón `Almientos Masía`_ recomienda la creación con organización (*) para evitar duplicidad e inconvenientes contables, de esta forma garantizamos la homogeneidad de los datos maestros.
